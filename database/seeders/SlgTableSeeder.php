...
class SlgTableSeeder extends Seeder
{
    ...
    {
      return "INSERT INTO states (id, name, capital) VALUES
        ...
        (17, 'Imo State', 'Owerri'),
        (18, 'Jigawa State', 'Dutse'),
        (19, 'Kaduna State', 'Kaduna'),
        (20, 'Kano State', 'Kano'),
        (21, 'Katsina State', 'Katsina'),
        (22, 'Kebbi State', 'Birnin Kebbi'),
        (23, 'Kogi State', 'Lokoja'),
        (24, 'Kwara State', 'Ilorin'),
        (25, 'Lagos State', 'Ikeja'),
        (26, 'Nasarawa State', 'Lafia'),
        (27, 'Niger State', 'Minna'),
        (28, 'Ogun State', 'Abeokuta'),
        (29, 'Ondo State', 'Akure'),
        (30, 'Osun State', 'Osogbo'),
        (31, 'Oyo State', 'Ibadan'),
        (32, 'Plateau State', 'os'),
        (33, 'Rivers State', 'Port Harcourt'),
        (34, 'Sokoto State', 'Sokoto'),
        (35, 'Taraba State', 'Jalingo'),
        (36, 'Yobe State', 'Damaturu'),
        (37, 'Zamfara State', 'Gusau')";
    }
